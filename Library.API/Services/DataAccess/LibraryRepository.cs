...
namespace Library.API.Services.DataAccess
{
    public class LibraryRepository : API.Services.DataAccess.ILibraryRepository
    {
        ...
        public PagedList<Author> GetAuthors(AuthorsResourceParameters authorResourceParameters)
        {
            //var collectionBeforePaging = 
            //    _context.Authors.OrderBy(a => a.FirstName).ThenBy(a => a.LastName).AsQueryable();
            ...
            return PagedList<Author>.Create(collectionBeforePaging, authorResourceParameters.PageNumber, authorResourceParameters.PageSize);
        }
